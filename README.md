...
This project is a web application built with ASP.NET Core MVC.
It is part of a school assignment.

-----------------

The goal was to build a gym portal where users can:
...
- Unit tests for domain logic (Member validation).
- Integration test for Training page.
...
Further practice will help strengthen this understanding.
